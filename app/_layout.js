...
async function initDB(db) {
  await db.execAsync(`PRAGMA journal_mode = WAL;
    ...
    INSERT INTO produit(nom, description, prix, image) values('Champignon', 'Donne un boost temporaire!', 8, 'mushroom_red');
    ...
    INSERT INTO produit(nom, description, prix, image) values('Fleur Boomerang', 'Lancez un boomerang trois fois!', 15, 'flower_boomrang');
